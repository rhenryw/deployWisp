> [!NOTE]
> This will soon be superceeded by [deployRay](https://github.com/rhenryw/deployRay/), as it is more secure and less detectable. Use deployRay if you value more websites over speed.
